...
<div class="app-container relative flex flex-col items-center justify-center gap-4 w-full h-screen">
	<h1 class="text-2xl font-bold text-opacity-70 text-center m-4">Confirme a sua presença!</h1>
		...
		<dialog id="info-modal" class="modal modal-open">
			<div class="modal-box p-0">
				...
				<div class="content p-4">
					<p class="text-center">confirmar presença</p>
					<div class="flex justify-center gap-2 p-4">
						<button class="btn border-2 border-error">Não consigo</button>
						<button class="btn border-2 border-success hover:btn-success">Vou aparecer</button>
					</div>
